    ...
    <div className="space-y-7">
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-slate-400">
          Join 2,500+ institutions on Iron Bridge Finance.
        </p>
      </div>
      ...
      <form action={formAction} className="space-y-4">
        ...
        {state?.success && (
          <div className="flex items-start gap-2.5 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-400 text-sm">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <label htmlFor="firstName" className="block text-xs font-semibold text-slate-400 uppercase tracking-wide">
              First Name
            </label>
            <Input
              id="firstName"
          ...
          <div className="space-y-1.5">
            <label htmlFor="lastName" className="block text-xs font-semibold text-slate-400 uppercase tracking-wide">
              Last Name
            </label>
            <Input
              id="lastName"
