...
export const metadata = {
  title: "Terms of Service | Iron Bridge Banking",
  description: "Terms and conditions governing the use of Iron Bridge Banking digital asset brokerage and custody services.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3 space-y-12 text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section id="intro" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Welcome to Iron Bridge Banking. These Terms of Service (&ldquo;Terms&rdquo;) constitute a legally binding agreement between Iron Bridge Banking Systems Ltd (&ldquo;Iron Bridge Banking,&ldquo; &ldquo;we,&ldquo; &ldquo;us,&ldquo; or &ldquo;our&rdquo;) and the institutional entity or corporation (&ldquo;Client,&ldquo; &ldquo;you,&ldquo; or &ldquo;your&rdquo;) accessing or using the Iron Bridge Banking digital asset brokerage, custody execution, and multi-party computation (MPC) vault platform.
              </p>
              <p>
            ...
            <section id="eligibility" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Iron Bridge Banking caters exclusively to eligible institutional clients, including corporate entities, financial institutions, asset managers, hedge funds, family offices, and high-net-worth corporate partners. We do not provide retail investment services.
              </p>
              <p>
            ...
            <section id="security" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Access to the Iron Bridge Banking platform is secured using advanced authentication and cryptographic keys. For custody vault access, Iron Bridge Banking implements a state-of-the-art Multi-Party Computation (MPC-CMP) key share system.
              </p>
              <p>
                You are solely responsible for maintaining the confidentiality and integrity of your corporate credentials, API keys, and local MPC key shares. You must restrict platform access only to authorized personnel and immediately notify Iron Bridge Banking at security@ironbridgebanking.com if you detect or suspect any unauthorized access, breach of API key security, or compromise of local credentials.
              </p>
            </section>
            ...
            <section id="trading" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Iron Bridge Banking provides institutional order routing, liquidity aggregation, and OTC execution services. All orders routed through our smart order router (SOR) are executed according to our Best Execution Policy.
              </p>
              <p>
                Orders, once placed and confirmed, are final and cannot be modified or canceled. Iron Bridge Banking does not guarantee execution speeds, liquidity availability, or specific price margins during periods of extreme market volatility or network congestion. In the event of system failures or liquidity provider outages, Iron Bridge Banking reserves the right to suspend order routing to protect customer assets.
              </p>
            </section>
            ...
            <section id="custody" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Custodial assets are segregated and stored across our cold, warm, and hot vault architectures. Iron Bridge Banking utilizes MPC technology where key shares are distributed across independent security modules and geographical jurisdictions to eliminate single points of failure.
              </p>
              <p>
                Iron Bridge Banking acts as a bailee of digital assets in custody and does not acquire any proprietary interest in your digital assets. All custodial transactions are governed by specific cold-storage delay times, multi-signature approval rules, and institutional threshold consensus protocols configured by your appointed administrators.
              </p>
            </section>
            ...
            <section id="fees" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Fees are denominated in the respective digital asset or fiat currency and will be automatically deducted from your account balances upon transaction execution or monthly billing cycles. Iron Bridge Banking reserves the right to modify fee schedules upon thirty (30) days written notice to the client.
              </p>
            </section>
            ...
            <section id="ip" className="scroll-mt-24 space-y-4">
              ...
              <p>
                All proprietary software, algorithms, user interface designs, logos, trade secrets, and API protocols used to deliver the Iron Bridge Banking brokerage and custody services are the exclusive property of Iron Bridge Banking Systems Ltd and its licensors.
              </p>
              <p>
                Subject to compliance with these Terms, Iron Bridge Banking grants you a limited, non-exclusive, non-transferable, revocable license to access the platform interface and APIs solely for the execution of your institutional digital asset operations. No other rights, explicit or implied, are granted under these Terms.
              </p>
            </section>
            ...
            <section id="liability" className="scroll-mt-24 space-y-4">
              ...
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, IRON BRIDGE BANKING SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR ASSET VALUE, ARISING OUT OF OR IN CONNECTION WITH PLATFORM USE, NETWORK FORKS, PROTOCOL VULNERABILITIES, OR FORCE MAJEURE EVENTS.
              </p>
              <p>
                You agree to indemnify, defend, and hold harmless Iron Bridge Banking, its affiliates, directors, officers, and employees from and against any claims, losses, liabilities, costs, and expenses (including legal fees) arising from your breach of these Terms, unauthorized account use, or violation of applicable laws and regulations.
              </p>
            </section>
