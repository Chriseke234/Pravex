...
export const metadata = {
  title: "Terms of Service | Pavex Institutional",
  description: "Terms and conditions governing the use of Pavex Institutional digital asset brokerage and custody services.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3 space-y-12 text-sm md:text-base text-muted-foreground leading-relaxed">
            ...
            <section id="intro" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Welcome to Pavex Institutional. These Terms of Service (&ldquo;Terms&rdquo;) constitute a legally binding agreement between Pavex Systems Ltd (&ldquo;Pavex,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) and the institutional entity or corporation (&ldquo;Client,&rdquo; &ldquo;you,&rdquo; or &ldquo;your&rdquo;) accessing or using the Pavex Institutional digital asset brokerage, custody execution, and multi-party computation (MPC) vault platform.
              </p>
              <p>
            ...
            <section id="eligibility" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Pavex Institutional caters exclusively to eligible institutional clients, including corporate entities, financial institutions, asset managers, hedge funds, family offices, and high-net-worth corporate partners. We do not provide retail investment services.
              </p>
              <p>
            ...
            <section id="security" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Access to the Pavex platform is secured using advanced authentication and cryptographic keys. For custody vault access, Pavex implements a state-of-the-art Multi-Party Computation (MPC-CMP) key share system.
              </p>
              <p>
                You are solely responsible for maintaining the confidentiality and integrity of your corporate credentials, API keys, and local MPC key shares. You must restrict platform access only to authorized personnel and immediately notify Pavex at security@pavex.com if you detect or suspect any unauthorized access, breach of API key security, or compromise of local credentials.
              </p>
            </section>
            ...
            <section id="trading" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Pavex provides institutional order routing, liquidity aggregation, and OTC execution services. All orders routed through our smart order router (SOR) are executed according to our Best Execution Policy.
              </p>
              <p>
                Orders, once placed and confirmed, are final and cannot be modified or canceled. Pavex does not guarantee execution speeds, liquidity availability, or specific price margins during periods of extreme market volatility or network congestion. In the event of system failures or liquidity provider outages, Pavex reserves the right to suspend order routing to protect customer assets.
              </p>
            </section>
            ...
            <section id="custody" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Custodial assets are segregated and stored across our cold, warm, and hot vault architectures. Pavex utilizes MPC technology where key shares are distributed across independent security modules and geographical jurisdictions to eliminate single points of failure.
              </p>
              <p>
                Pavex acts as a bailee of digital assets in custody and does not acquire any proprietary interest in your digital assets. All custodial transactions are governed by specific cold-storage delay times, multi-signature approval rules, and institutional threshold consensus protocols configured by your appointed administrators.
              </p>
            </section>
            ...
            <section id="fees" className="scroll-mt-24 space-y-4">
              ...
              <p>
                Fees are denominated in the respective digital asset or fiat currency and will be automatically deducted from your account balances upon transaction execution or monthly billing cycles. Pavex reserves the right to modify fee schedules upon thirty (30) days written notice to the client.
              </p>
            </section>
            ...
            <section id="ip" className="scroll-mt-24 space-y-4">
              ...
              <p>
                All proprietary software, algorithms, user interface designs, logos, trade secrets, and API protocols used to deliver the Pavex Institutional brokerage and custody services are the exclusive property of Pavex Systems Ltd and its licensors.
              </p>
              <p>
                Subject to compliance with these Terms, Pavex grants you a limited, non-exclusive, non-transferable, revocable license to access the platform interface and APIs solely for the execution of your institutional digital asset operations. No other rights, explicit or implied, are granted under these Terms.
              </p>
            </section>
            ...
            <section id="liability" className="scroll-mt-24 space-y-4">
              ...
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, PAVEX SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR ASSET VALUE, ARISING OUT OF OR IN CONNECTION WITH PLATFORM USE, NETWORK FORKS, PROTOCOL VULNERABILITIES, OR FORCE MAJEURE EVENTS.
              </p>
              <p>
                You agree to indemnify, defend, and hold harmless Pavex, its affiliates, directors, officers, and employees from and against any claims, losses, liabilities, costs, and expenses (including legal fees) arising from your breach of these Terms, unauthorized account use, or violation of applicable laws and regulations.
              </p>
            </section>
