      ...
      <main className="max-w-7xl mx-auto px-4 space-y-8">
        ...
        <div className="bg-card/[0.02] border border-border/30 p-8 rounded-3xl mt-8">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-4xl">
            ...
            Institutional investors utilize Iron Bridge Finance to gain exposure to {asset.name} via regulated custodial accounts with microsecond execution latency and deep aggregated liquidity.
          </p>
        </div>
