...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do Trade Finance Letters of Credit work?", a: "Iron Bridge Banking issues an irrevocable Letter of Credit guaranteeing payment to your overseas supplier upon presentation of verified shipping documents (Bill of Lading, Commercial Invoice)." },
