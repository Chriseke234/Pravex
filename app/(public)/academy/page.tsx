...
export const metadata: Metadata = {
  title: "Iron Bridge Finance Academy",
        ...
        <section className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            ...
            <h1 className="text-6xl font-bold tracking-tight">
              Iron Bridge Finance <span className="text-gradient">Academy</span>
            </h1>
        ...
        <section className="py-20 rounded-[3rem] bg-primary/[0.03] border border-white/5 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center space-y-8 relative z-10">
            ...
            <p className="text-lg text-muted-foreground">
              Subscribe to the Iron Bridge Finance newsletter and receive weekly market analysis and platform updates directly in your inbox.
            </p>
