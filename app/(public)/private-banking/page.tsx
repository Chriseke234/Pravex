  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[420px] rounded-3xl overflow-hidden border border-slate-200 shadow-xl">
          <Image
      ...
      <section className="py-20 bg-slate-100/70 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-serif font-bold text-slate-900">Private Client Sub-Services</h2>
            <p className="text-slate-600 max-w-xl mx-auto">Tailored wealth solutions designed for sophisticated individual and institutional capital.</p>
          </div>
