      ...
      <div className="max-w-5xl mx-auto px-4 space-y-16">
        <div className="space-y-4 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-semibold">
            <Home className="w-4 h-4" /> Residential Mortgages
          </div>
          <h1 className="text-4xl md:text-6xl font-serif font-bold">Mortgage Loans</h1>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Competitive fixed and tracker mortgages for first-time buyers, home movers, and buy-to-let investors with up to 85% LTV.
          </p>
          <div className="pt-4">
            <Link href="/loans-and-credits/calculator">
              <Button size="lg" className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold gap-2">
                Calculate Payments First <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
          </div>
        </div>
