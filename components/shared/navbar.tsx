...
function ThemeToggle({ className }: { className?: string }) {
  ...
  if (!mounted) {
    return <div className={cn("w-10 h-10 rounded-xl", className)} />;
  }
  ...
  return (
    <button
      ...
      className={cn(
        "w-10 h-10 rounded-xl flex items-center justify-center transition-colors focus:outline-none",
    ...
    <>
      <nav
        className={cn(
          ...
          scrolled
            ? "bg-white/95 dark:bg-slate-950/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800/80 shadow-sm dark:shadow-xl dark:shadow-slate-950/40"
            : "bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm border-b border-slate-200/60 dark:border-slate-900"
        )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-1">
              {MEGA_MENUS.map((menu) => (
                ...
                >
                  ...
                  >
                    {menu.title}
                    <ChevronDown className={cn("w-3.5 h-3.5 transition-transform duration-200 text-slate-400", activeMenu === menu.title && "rotate-180 text-amber-500 dark:text-amber-400")} />
                  </Link>

                  {/* Dropdown Card */}
                  {activeMenu === menu.title && (
                    <div className="absolute top-full left-0 w-80 mt-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-3 shadow-2xl backdrop-blur-xl animate-fade-in z-50">
                      <div className="space-y-1">
                        {menu.items.map((sub) => {
                          ...
                          return (
                            ...
                            >
                              <div className="w-7 h-7 rounded-lg bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-amber-500 group-hover:text-slate-950 transition-colors">
              ...
              <Link
                ...
                className={cn(
                  ...
                  pathname === "/about" ? "text-amber-600 dark:text-amber-400 bg-amber-500/10 font-semibold" : "text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/70"
                )}
              >
                About Us
              </Link>
              ...
              <Link
                ...
                className={cn(
                  "px-3 py-2 rounded-lg text-sm font-medium transition-colors",
                  pathname === "/contact" ? "text-amber-600 dark:text-amber-400 bg-amber-500/10 font-semibold" : "text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/70"
                )}
              >
                Contact
              </Link>
          ...
          <div className="lg:hidden flex items-center gap-2">
            ...
            <button
              ...
              className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-700 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white hover:border-amber-500/50 transition-colors focus:outline-none active:scale-95"
            >
      ...
      {mounted && isMobileMenuOpen && createPortal(
        <div className="fixed inset-0 z-[999] flex flex-col justify-between bg-white dark:bg-slate-950 text-slate-900 dark:text-white animate-fade-in overflow-hidden h-screen h-[100dvh]">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar px-4 sm:px-6 py-5 space-y-6">
            ...
            <div className="bg-slate-100/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800/90 rounded-2xl p-4 shadow-sm dark:shadow-xl">
              {user ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Signed in as</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Client Access Portal</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <Link href="/login" onClick={closeMenu}>
                      <Button variant="outline" className="w-full border-slate-300 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-900 dark:text-slate-200 text-xs font-semibold py-2.5 rounded-xl">
                        Sign In
                      </Button>
                    </Link>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isExpanded
                        ? "bg-slate-100/90 dark:bg-slate-900/90 border-amber-500/40 shadow-md"
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3.5 text-left focus:outline-none group active:bg-slate-200/50 dark:active:bg-slate-800/40"
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={cn(
                            ...
                            isExpanded || isActiveCategory
                              ...
                              : "bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 group-hover:text-slate-950 dark:group-hover:text-white"
                          )}
                        >
                        ...
                        <div>
                          <span className={cn(
                            ...
                            isExpanded || isActiveCategory ? "text-amber-600 dark:text-amber-400" : "text-slate-900 dark:text-white"
                          )}>
                            {menu.title}
                          </span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-[9px] font-semibold text-slate-600 dark:text-slate-400 bg-slate-200/70 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 px-2 py-0.5 rounded-full">
                          {menu.badge}
                        </span>
                        <ChevronDown
                          className={cn(
                    ...
                    {/* Accordion Content */}
                    {isExpanded && (
                      <div className="px-3 pb-3 pt-1 space-y-1 border-t border-slate-200 dark:border-slate-800/80 bg-white/70 dark:bg-slate-950/60">
                        {menu.items.map((sub) => {
                          const SubIcon = sub.icon;
                          ...
                          return (
                            <Link
                              ...
                              onClick={closeMenu}
                              className={cn(
                                "flex items-center gap-3 p-2.5 rounded-xl text-xs font-medium transition-colors group active:bg-slate-100 dark:active:bg-slate-800",
                                isSubActive
                            ...
                            >
                              ...
                              <ArrowRight className="w-3 h-3 text-slate-400 group-hover:text-amber-500 transition-transform group-hover:translate-x-0.5" />
                            </Link>
                          );
                        })}
                      </div>
            ...
            <div className="space-y-1 pt-1">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Link
                  href="/about"
                  onClick={closeMenu}
                  className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100/70 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-900 transition-colors"
                >
                ...
                <Link
                  ...
                  className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100/70 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-900 transition-colors"
                >
                  <Mail className="w-4 h-4 text-amber-500" /> Support Desk
                </Link>
                <Link
                  ...
                  className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100/70 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-900 transition-colors"
                >
                  <Calculator className="w-4 h-4 text-amber-500" /> Calculator
                </Link>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 rounded-2xl p-3.5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-900 dark:text-white">Private Concierge</p>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">24/7 Priority Member Desk</p>
                </div>
              </div>
              <Link href="/contact" onClick={closeMenu}>
                <Button size="sm" variant="ghost" className="h-8 text-xs font-bold text-amber-600 dark:text-amber-400 hover:text-slate-950 dark:hover:text-white hover:bg-amber-500/20">
                  Call Desk
                </Button>
              </Link>
            </div>
          ...
          <div className="p-4 border-t border-slate-200/80 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950 shrink-0 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
            <div className="flex items-center gap-2">
