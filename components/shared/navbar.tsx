...
function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "w-10 h-10 rounded-xl text-slate-400 hover:text-white bg-slate-900 hover:bg-slate-800 border border-slate-800/80 transition-colors flex items-center justify-center focus:outline-none",
        className
      )}
