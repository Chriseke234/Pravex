    ...
    <footer className="border-t border-slate-200 bg-slate-50 text-slate-700 text-sm">
      ...
      <div className="border-t border-slate-200 bg-slate-100/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-4 text-xs text-slate-600 leading-relaxed">
          <p>
            <strong className="text-slate-900 font-semibold">Regulatory &amp; Security Disclosure:</strong> Iron Bridge Finance is a premier digital banking platform providing corporate treasury, private wealth management, and commercial settlement solutions. All digital infrastructure and treasury vaults operate under zero-trust protocols and multi-institution security architectures.
          </p>
          <p>
          ...
          <div className="pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-600 text-[11px] font-medium">
            <p>&copy; {new Date().getFullYear()} Iron Bridge Finance Ltd. All rights reserved.</p>
