...
export function Topbar() {
  ...
  return (
    <header className="h-16 fixed top-0 right-0 left-0 lg:left-64 bg-slate-950/90 backdrop-blur-md border-b border-slate-800/70 flex items-center justify-between px-4 lg:px-6 z-40">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/dashboard/notifications" aria-label="Notifications">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-amber-500 rounded-full border-2 border-slate-950" />
            )}
          </Button>
        </Link>
